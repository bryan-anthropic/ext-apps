...
const cspValue = `
  default-src 'none';
  script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: ${csp?.resourceDomains?.join(' ') || ''};
  style-src 'self' 'unsafe-inline' blob: data: ${csp?.resourceDomains?.join(' ') || ''};
  connect-src 'self' ${csp?.connectDomains?.join(' ') || ''};
  img-src 'self' data: blob: ${csp?.resourceDomains?.join(' ') || ''};
  font-src 'self' data: blob: ${csp?.resourceDomains?.join(' ') || ''};
  media-src 'self' data: blob: ${csp?.resourceDomains?.join(' ') || ''};
  worker-src 'self' blob: ${csp?.resourceDomains?.join(' ') || ''};
